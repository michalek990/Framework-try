...
mongoose.connect("mongodb://localhost/productDB", {useUnifiedTopology: true, useNewUrlParser: true, useCreateIndex: true });
var fs = require('fs');
var product = require("./model/product.js");
var user = require("./model/user.js");


//tworzymy folder, który bedzie przechowywał 
//zdjęcie z obrazkami zaimportowanymi
...
var upload = multer({
  ...
  //zabezpieczenie przed dodaniem innego formatu pliku
...
/*Api szukanie produktu po nazwie*/
