  ...
  render() {
    return (
      <div>
        ...
        >
          <DialogTitle id="alert-dialog-title">Edycja produktu</DialogTitle>
          <DialogContent>
            <TextField
              id="standard-basic"
              type="text"
        ...
        >
          ...
          <DialogTitle id="alert-dialog-title">Dodaj nowy produkt</DialogTitle>
          <DialogContent class="x">
            <TextField
              id="standard-basic"
              type="text"
              autoComplete="off"
          ...
          <Table aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center">Obrazek</TableCell>
